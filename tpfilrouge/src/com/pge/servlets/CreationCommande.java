...
public class CreationCommande extends HttpServlet {
    ...
    public void doGet( HttpServletRequest request, HttpServletResponse response ) throws ServletException, IOException {
        ...
        // TP fil rouge partie 4 : on envoie la liste des clients pour les
        // afficher dans un select et pouvoir en sélectionner un
        HttpSession session = request.getSession();

        // On récupère la liste des clients présente en session et on la passe
        // en attribut de la requête
    ...
    public void doPost( HttpServletRequest request, HttpServletResponse response )
        ...
        /*
         * Récupération du paramètre chemin passé à la servlet lors de
         * l'initialisation par l'intermédiaire du web.xml
         */
